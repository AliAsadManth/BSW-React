  ...
  return (
    <div div style={{ position: "relative", overflowX: "hidden" }}>
      ...
      <Container>
        ...
        >
          <Typography style={{ fontSize: 18, color: "grey", width: "100%" }}>
            <p>Welcome to BSW Engineering!</p>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of BSW Engineering's Website, located at
              https://bswengineering.com/.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use BSW Engineering if you do not
            ...
            <p>
              We employ the use of cookies. By accessing BSW Engineering, you
              agreed to use cookies in agreement with the BSW Engineering's
              Privacy Policy.{" "}
            </p>
            ...
            <p>
              Unless otherwise stated, BSW Engineering and/or its licensors own
              the intellectual property rights for all material on BSW
              Engineering. All intellectual property rights are reserved. You
              may access this from BSW Engineering for your own personal use
              subjected to restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from BSW Engineering</li>
              <li>Sell, rent or sub-license material from BSW Engineering</li>
              <li>
                Reproduce, duplicate or copy material from BSW Engineering
              </li>
              <li>Redistribute content from BSW Engineering</li>
            </ul>
            ...
            <p>
              ...
              BSW Engineering does not filter, edit, publish or review Comments
              prior to their presence on the website. Comments do not reflect
              the views and opinions of BSW Engineering,its agents and/or
              ...
              applicable laws, BSW Engineering shall not be liable for the
            ...
            <p>
              BSW Engineering reserves the right to monitor all Comments and to
            ...
            <p>
              You hereby grant BSW Engineering a non-exclusive license to use,
            ...
            <p>
              ...
              BSW Engineering; and (d) the link is in the context of general
            ...
            <p>
              ...
              by sending an e-mail to BSW Engineering. Please include your name,
            ...
            <p>
              No use of BSW Engineering's logo or other artwork will be allowed
